            ...
            <ScrollArea>
              ...
              <div className="flex justify-between items-center px-3 py-2 border-b border-gray-200 dark:border-graydark-300">
                <Text size="14">
                  ...
                  complete, the daemon can start storing data.
                </Text>
              </div>
              <Section
                title={
                ...
                description={
                  'Specify your maximum pricing values and other settings.'
                }
                action={
              ...
              <Section
                ...
                description={`Fund your wallet to cover spending on storage.${
              ...
              <Section
                title={
                  <Link href={routes.home} ellipsis size="14" underline="hover">
