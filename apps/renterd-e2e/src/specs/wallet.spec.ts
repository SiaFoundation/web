...
// Sometimes the wallet balance is confirmed but not spendable immediately after
// the cluster is started. This function mines and waits until it is spendable.
