...
function Foundation({ team, featured, reports }: Props) {
  return (
    ...
    >
      <SectionGradient className="pt-12 pb-24 lg:pt-32 lg:pb-40">
        <div className="flex flex-col">
          ...
          <div className="flex flex-col">
            <SiteHeading size="24" title="Contact" className="mt-24 mb-5" />
      ...
      <SectionWaves className="pt-20 pb-32">
        <SiteHeading className="pb-20" size="32" title="The Sia team" />
      ...
      <SectionGradient className="pt-40 pb-40">
