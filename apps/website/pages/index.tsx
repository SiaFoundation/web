...
export default function Home({
  ...
  return (
    ...
    >
      <SectionSimple className="pt-12 pb-20">
      ...
      <SectionGradient className="pt-16 pb-40">
        <SiteHeading
          size="32"
      ...
      <SectionWaves className="pt-16 pb-32">
        <SiteHeading
          size="32"
      ...
      <SectionGradient className="pt-32 pb-20">
        <SiteHeading
          size="32"
