    ...
    return [
      {
        ...
        hash: contract.renterPayoutValid.address,
      },
      {
        label: 'host payout',
        initials: 'h',
        ...
        hash: contract.hostPayoutValid.address,
      },
    ...
    return [
      {
        ...
        hash: contract.renterPayoutMissed.address,
      },
      {
