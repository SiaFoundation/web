...
- 00c9de5: Price pinning is now all or nothing - the per-price pin toggles have been replaced with a single Pin prices switch that pins storage price, egress price, ingress price, and max collateral together. Hosts that currently have only some of their prices pinned keep that configuration until they change pinning themselves.
