...
export function Point({
  ...
  return (
    ...
    >
      ...
      />
      <div
        className="hidden group-hover:flex absolute justify-between gap-1 bottom-[100%]"
        style={{
          left: toPercent(eventPos),
        }}
      >
        <BlockLabel blockHeight={eventHeight} align="start" variant="primary" />
        <RelativeLabel variant="primary">{label}</RelativeLabel>
      </div>
      <div
        className="hidden group-hover:flex absolute justify-between gap-1 top-[100%]"
        style={{
          left: toPercent(eventPos),
        }}
      >
