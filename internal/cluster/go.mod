...
require (
	go.sia.tech/cluster v0.1.6-0.20260814081244-6e330a0afa47
...
require (
	...
	go.sia.tech/hostd/v2 v2.10.2 // indirect
	go.sia.tech/indexd v0.4.2 // indirect
	go.sia.tech/jape v0.14.1 // indirect
	go.sia.tech/mux v1.5.3 // indirect
	go.sia.tech/renterd/v2 v2.9.3 // indirect
	go.sia.tech/walletd/v2 v2.15.2 // indirect
